...
def LatexOLSTableOutEight(title: str, variableSets: List[VariableSet], results):
    tableOut = Template(r'''
                \documentclass{article}
                \usepackage[utf8]{inputenc}
                \\
    ...
    tableOut = tableOut.substitute(
        title=title, nObs="{:.3f}".format(results.nobs), r2="{:.3f}".format(results.rsquared), adjR2="{:.3f}".format(results.rsquared_adj), fstat="{:.3f}".format(results.fvalue), pFstat="{:.3f}".format(results.f_pvalue),
        var1=variableSets[0].xTitle, var2=variableSets[1].xTitle, var3=variableSets[
            2].xTitle, var4=variableSets[3].xTitle, var5=variableSets[4].xTitle, var6=variableSets[5].xTitle,  var7=variableSets[6].xTitle, var8=variableSets[7].xTitle,
        cCoef=coefs[0], v1Coef=coefs[1], v2Coef=coefs[2], v3Coef=coefs[3], v4Coef=coefs[
            4], v5Coef=coefs[5], v6Coef=coefs[6], v7Coef=coefs[7], v8Coef=coefs[8],
        cStdErr=stdErrs[0], v1StdErr=stdErrs[1], v2StdErr=stdErrs[2], v3StdErr=stdErrs[
            3], v4StdErr=stdErrs[4], v5StdErr=stdErrs[5], v6StdErr=stdErrs[6], v7StdErr=stdErrs[7], v8StdErr=stdErrs[8],
        cTval=tVals[0], v1Tval=tVals[1], v2Tval=tVals[2], v3Tval=tVals[3], v4Tval=tVals[
            4], v5Tval=tVals[5], v6Tval=tVals[6], v7Tval=tVals[7], v8Tval=tVals[8],
        cPT=pTVals[0], v1cPT=pTVals[1], v2cPT=pTVals[2], v3cPT=pTVals[3], v4cPT=pTVals[4], v5cPT=pTVals[5], v6cPT=pTVals[6], v7cPT=pTVals[7], v8cPT=pTVals[8])

    return tableOut


def LatexOLSTableOutSeven(title: str, variableSets: List[VariableSet], results):
    tableOut = Template(r'''
                \documentclass{article}
                \usepackage[utf8]{inputenc}
                \\
    ...
    tableOut = tableOut.substitute(
        title=title, nObs="{:.3f}".format(results.nobs), r2="{:.3f}".format(results.rsquared), adjR2="{:.3f}".format(results.rsquared_adj), fstat="{:.3f}".format(results.fvalue), pFstat="{:.3f}".format(results.f_pvalue),
        var1=variableSets[0].xTitle, var2=variableSets[1].xTitle, var3=variableSets[
            2].xTitle, var4=variableSets[3].xTitle, var5=variableSets[4].xTitle, var6=variableSets[5].xTitle,  var7=variableSets[6].xTitle,
        cCoef=coefs[0], v1Coef=coefs[1], v2Coef=coefs[2], v3Coef=coefs[3], v4Coef=coefs[
            4], v5Coef=coefs[5], v6Coef=coefs[6], v7Coef=coefs[7],
        cStdErr=stdErrs[0], v1StdErr=stdErrs[1], v2StdErr=stdErrs[2], v3StdErr=stdErrs[
            3], v4StdErr=stdErrs[4], v5StdErr=stdErrs[5], v6StdErr=stdErrs[6], v7StdErr=stdErrs[7],
        cTval=tVals[0], v1Tval=tVals[1], v2Tval=tVals[2], v3Tval=tVals[3], v4Tval=tVals[
            4], v5Tval=tVals[5], v6Tval=tVals[6], v7Tval=tVals[7],
        cPT=pTVals[0], v1cPT=pTVals[1], v2cPT=pTVals[2], v3cPT=pTVals[3], v4cPT=pTVals[4], v5cPT=pTVals[5], v6cPT=pTVals[6], v7cPT=pTVals[7])
